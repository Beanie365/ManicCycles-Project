...
(3, 'mannym@gmail.com', 'manmanny', 'passwordM11', 'Manny', 'Managerman', 'manager'),
...
--
ALTER TABLE `bicycle`
  MODIFY `bicycleID` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `frame`
  MODIFY `frameID` int(12) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `quote`
  MODIFY `quoteID` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `quoteservices`
--
ALTER TABLE `quoteservices`
  MODIFY `quoteServiceID` int(15) NOT NULL AUTO_INCREMENT;
